...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Fixed Header spacing properties to prevent clipping */
        header { 
        ...
        /* Two-Column Management Layout split */
...
<body>
    ...
    <div style="background-color: #28a745; color: white; padding: 14px 30px; text-align: center; font-size: 14px; font-weight: 600; border-bottom: 2px solid #1e7e34; letter-spacing: 0.5px;">
        ✓ Admin Gateway Connected securely to Database (`supermarket_db`).
    </div>
    ...
    <div class="admin-container">
        ...
        <div class="management-grid">
            <div class="admin-card">
                ...
                <form action="#" method="POST" onsubmit="event.preventDefault(); alert('GUI Layout Working! In Week 3, this form will push data directly to phpMyAdmin.');">
                    
                    <div class="form-group">
                        <label>Product Name</label>
                        <input type="text" placeholder="e.g., Organic Bananas (1kg)" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" placeholder="e.g., 2.99" required>
                    </div>

                    <div class="form-group">
                        <label>Product Visual Emoji representation</label>
                        <input type="text" placeholder="e.g., 🍌" required>
                    </div>
            ...
            <div class="admin-card">
                ...
                <div class="form-group">
                    <div class="system-status-box">
                        ...
                        <p><strong>Current View Mode:</strong> Layout Wireframe GUI</p>
                        <br>
                        <p>This control center panel will process programmatic SQL insert queries as we advance directly into your Week 3 backend implementation phase.</p>
                    </div>
                </div>
            </div>
        </div>
